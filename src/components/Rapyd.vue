                        ...
                        <div class="all-field mt-6">
                            <div class="client-name">
                                ...
                                <v-text-field dense color="red darken-2" :placeholder="$t('payment-providers_page.form.client_name')"
                                    v-model="formData.rapyd_client_name" required variant="outlined" density="compact"
                            ...
                            <div class="secret-key">
                                ...
                                <v-text-field dense color="red darken-2" :placeholder="$t('payment-providers_page.form.secret_key')"
                                    v-model="formData.rapyd_secret_key" required variant="outlined" density="compact"
                            ...
                            <div class="access-key">
                                ...
                                <v-text-field dense color="red darken-2" :placeholder="$t('payment-providers_page.form.access_key')"
                                    v-model="formData.rapyd_access_key" required variant="outlined" density="compact"
                    ...
                    <div class="config-col-wrapper all-field">
                        <div class="payment-provider-status">
                            ...
                            <div class="d-flex justify-space-between align-center">
                                ...
                                <v-switch v-model="formData.rapyd_is_active" hide-details inset :true-value="true"
                        ...
                        <div class="description-field mt-3">
                            ...
                            <div class="message-description">
                                ...
                                <v-textarea dense color="red darken-2" :placeholder="$t('payment-providers_page.form.client_description')"
                                    v-model="formData.rapyd_client_description" variant="outlined" density="compact" :rules="[v => englishRule(v, $t)]"  />
                            </div>
                        </div>
                        <v-col cols="12" sm="12">
...
export default {
    ...
    data() {
        return {
            formData: {
                rapyd_client_name: this.RapydObj.credential.client_name,
                rapyd_client_description: this.RapydObj.credential.client_description,
                rapyd_secret_key: this.RapydObj.credential.secret_key,
                rapyd_access_key: this.RapydObj.credential.access_key,
                rapyd_is_active: this.RapydObj.credential.is_active,
            },
            logo: this.RapydObj.logo_url,
            displayName: this.RapydObj.transaction_obj.display_name,
            isFormValid: false,
            providerName: this.RapydObj.transaction_obj.provider_name,
        };
    },
    computed: {
    ...
    methods: {
        ...
        async SaveData() {
            ...
            if (result.valid) {
                ...
                this.saveRapydSettings(finalData);
            } else {
