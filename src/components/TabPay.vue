                        ...
                        <div class="all-field mt-6">
                            <div class="client-name">
                                ...
                                <v-text-field dense color="red darken-2" :placeholder="$t('payment-providers_page.form.client_name')"
                                    v-model="formData.tabpay_client_name" required variant="outlined" density="compact"
                            ...
                            <div class="secret-key">
                                ...
                                <v-text-field dense color="red darken-2" :placeholder="$t('payment-providers_page.form.secret_key')"
                                    v-model="formData.tabpay_secret_key" required variant="outlined" density="compact"
                    ...
                    <div class="config-col-wrapper all-field">
                        <div class="payment-provider-status">
                            ...
                            <div class="d-flex justify-space-between align-center">
                                ...
                                <v-switch v-model="formData.tabpay_is_active" hide-details inset :true-value="true"
                        ...
                        <div class="description-field mt-3">
                            ...
                            <div class="message-description">
                                ...
                                <v-textarea dense color="red darken-2" :placeholder="$t('payment-providers_page.form.client_description')"
                                    v-model="formData.tabpay_client_description" variant="outlined" density="compact" :rules="[v => englishRule(v, $t)]" />
                            </div>
                        </div>
...
export default {
    ...
    data() {
        return {
            formData: {
                tabpay_client_name: this.TabPayObj.credential.client_name,
                tabpay_client_description: this.TabPayObj.credential.client_description,
                tabpay_secret_key: this.TabPayObj.credential.secret_key,
                tabpay_is_active: this.TabPayObj.credential.is_active,
            },
            logo: this.TabPayObj.logo_url,
            displayName: this.TabPayObj.transaction_obj.display_name,
            isFormValid: false,
            providerName: this.TabPayObj.transaction_obj.provider_name,
        };
    },
    computed: {
    ...
    methods: {
        ...
        async SaveData() {
            ...
            if (result.valid) {
                ...
                this.saveTabPaySettings(finalData);
            } else {
